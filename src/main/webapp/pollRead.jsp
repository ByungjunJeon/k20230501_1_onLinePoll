...
<!-- favicon: 웹 브라우저의 주소창에 표시되는 사이트를 대표하는 이미지이다. -->
<link rel="icon" href="./favicon-16x16.png">

</head>
<body>

<!-- 투표 항목이 저장된 텍스트 파일을 읽어 웹 브라우저에 출력한다. -->
<%
//	이클립스는 프로젝트를 실행하면 프로젝트를 이클립스가 내부적으로 상용하는 웹 서버에 복사하고 실행한다.
//	application.getRealPath("/")메소드를 실행하면 프로젝트가 실행되는 실제(real) 경로(path)를 얻어온다.
//	out.println(application.getRealPath("/"));
//	C:\K-Digital\web\workspace\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\k20230501_1_onLinePoll\
...
<table border="1" width="500" align="center" cellspacing="0" cellpadding="5">
	<tr>  <!-- 줄 -->
		<th> <!-- 칸, 표의 첫줄 또는 첫 열을 구성하는 칸, 굵게 밑 가운데 정렬이 되어서 표시된다. -->
			<%=poll.get(0)%>
		</th>
	</tr>
<%
//	투표 항목의 개수만큼 반복하며 radio버튼과 투표 항목을 출력한다.
	for (int i=1; i<itemCount; i++) {
%>
	<tr>  
		<td> <!-- 칸, 표의 첫줄 또는 첫 열을 제외한 나머지를 구성칸하는 칸 -->
